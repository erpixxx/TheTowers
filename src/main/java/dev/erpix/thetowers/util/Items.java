...
public final class Items {
    ...
    public static final Map<String, Supplier<ItemStack>> ITEMS = new HashMap<>() {{
        ...
        put("blue_helmet",          () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.BLUE.getColorHex(), 16))));
        put("red_helmet",           () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.RED.getColorHex(), 16))));
        put("green_helmet",         () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.GREEN.getColorHex(), 16))));
        put("yellow_helmet",        () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.YELLOW.getColorHex(), 16))));
        put("orange_helmet",        () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.ORANGE.getColorHex(), 16))));
        put("purple_helmet",        () -> getLeatherHelmet(Color.fromRGB(Integer.parseInt(TTeam.Color.PURPLE.getColorHex(), 16))));
        put("blue_chestplate",      () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.BLUE.getColorHex(), 16))));
        put("red_chestplate",       () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.RED.getColorHex(), 16))));
        put("green_chestplate",     () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.GREEN.getColorHex(), 16))));
        put("yellow_chestplate",    () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.YELLOW.getColorHex(), 16))));
        put("orange_chestplate",    () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.ORANGE.getColorHex(), 16))));
        put("purple_chestplate",    () -> getLeatherChestplate(Color.fromRGB(Integer.parseInt(TTeam.Color.PURPLE.getColorHex(), 16))));
        put("blue_leggings",        () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.BLUE.getColorHex(), 16))));
        put("red_leggings",         () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.RED.getColorHex(), 16))));
        put("green_leggings",       () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.GREEN.getColorHex(), 16))));
        put("yellow_leggings",      () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.YELLOW.getColorHex(), 16))));
        put("orange_leggings",      () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.ORANGE.getColorHex(), 16))));
        put("purple_leggings",      () -> getLeatherLeggings(Color.fromRGB(Integer.parseInt(TTeam.Color.PURPLE.getColorHex(), 16))));
        put("blue_boots",           () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.BLUE.getColorHex(), 16))));
        put("red_boots",            () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.RED.getColorHex(), 16))));
        put("green_boots",          () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.GREEN.getColorHex(), 16))));
        put("yellow_boots",         () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.YELLOW.getColorHex(), 16))));
        put("orange_boots",         () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.ORANGE.getColorHex(), 16))));
        put("purple_boots",         () -> getLeatherBoots(Color.fromRGB(Integer.parseInt(TTeam.Color.PURPLE.getColorHex(), 16))));
    }};
