...
/**
 * Represents the keys for various game statistics <b>within</b> the game.
 *
 * <p>Each key corresponds to a specific type of statistic that can be tracked.</p>
 */
public enum GameStatKey implements TypedStat {
    ...
    GameStatKey(@NotNull String key) {
        this.key = key;
    }
    ...
    public static @Nullable GameStatKey fromKey(@NotNull String key) {
        for (GameStatKey type : values()) {
